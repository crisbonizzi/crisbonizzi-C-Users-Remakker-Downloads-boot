	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				Passagens p1 = new Passagens(id, preco_passagem, data_ida_passagem, data_volta_passagem,
						origem_passagem, compra, destino, pacote_viagem);
			...
			case 2:
				...
				for (Passagens p : passagensDAO.getPassagens()) {
					System.out.println("Id: " + p.getId() + " Preco: " + p.getPreco_passagem() + " Data_ida: "
							+ p.getData_ida_passagem() + " Data_volta: " + p.getData_volta_passagem() + " Origem: "
							+ p.getOrigem_passagem() + " Compra: " + p.getCompra() + " Destino:" + p.getDestino()
							+ " Pacote_Viagem:" + p.getPacote_Viagem());
				}
			...
			case 3:
				...
				Passagens p2 = new Passagens(id, preco_passagem, data_ida_passagem, data_volta_passagem,
						origem_passagem, compras, destinos, pacote_viagens);
			...
			case 5:
				...
				System.out.println("Id: " + p3.getId() + " Preco " + p3.getPreco_passagem() + " Data_ida: "
						+ p3.getData_ida_passagem() + " Data_volta: " + p3.getData_volta_passagem() + " Origem: "
						+ p3.getOrigem_passagem() + " Compra: " + p3.getCompra() + " Destino:" + p3.getDestino()
						+ " Pacote_Viagem:" + p3.getPacote_Viagem());
